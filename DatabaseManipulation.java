...
//
// DatabaseManipulation.java: 我们使用对应的连接分别连接Postgres和OpenGauss
...
public class DatabaseManipulation implements DataManipulation {
    ...
    public String findMovieById(int id) {
        ...
        try {
            ...
            result = "Runtime of this [Database] findMovieById is " + timer.stop() + "ns";
            // 余下的打印极其耗时
    ...
    public String findMovieByTitleStrict(String title) {
        ...
        try {
            ...
            resultSet = preparedStatement.executeQuery();
            result = "Runtime of this [Database] findMovieByTitleStrict is " + timer.stop() + "ns";
    ...
    public String findMovieByTitleLike(String like) {
        ...
        try {
            ...
            resultSet = preparedStatement.executeQuery();
            result = "Runtime of this [Database] findMovieByTitleLike is " + timer.stop() + "ns";
            // 余下的打印极其耗时
    ...
    public String updatePeopleNamesTTOO() {
        ...
        try {
            ...
            result = "Runtime of this [Database] updatePeopleNamesTTOO is " + timer.stop() + "ns";
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            closeConnection();
    ...
    public String findMovieByConstraintNationAndReleaseYear_usingGoodLogic(String nation, int year1, int year2) {
        ...
        try {
            ...
            resultSet = preparedStatement.executeQuery();
            result = "Runtime of this [Database] findMovieByConstraintNationAndReleaseYear_usingGoodLogic is " + timer.stop() + "ns";
            // 余下的打印极其耗时
    ...
    public String findMovieByConstraintNationAndReleaseYear_usingBadLogic(String nation, int year1, int year2) {
        ...
        try {
            ...
            preparedStatement.setInt(3, year2);
            resultSet = preparedStatement.executeQuery();
            result = "Runtime of this [Database] findMovieByConstraintNationAndReleaseYear_usingBadLogic is " + timer.stop() + "ns";
            // 余下的打印极其耗时
    ...
    public String findTripOf_n_Passengers(int n, int group) {
        ...
        try {
            ...
            resultSet = preparedStatement.executeQuery();
            result = "Runtime of this [Database] findTripOf_n_Passenger is " + timer.stop() + "ns";
...
//            }
    ...
    public String updateDistance_mt_d(int d, int group) {
        ...
        try {
            ...
            preparedStatement.executeUpdate();
            result = "Runtime of this [Database] updateDistance_mt_d is " + timer.stop() + "ns";
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
            closeConnection();
